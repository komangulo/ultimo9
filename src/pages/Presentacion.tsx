          ...
          <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center">
            <div className="max-w-3xl text-white">
              ...
              <p className="text-lg mb-6 whitespace-pre-line">
                Dominante con más de 14 años de experiencia real en el mundo del BDSM, explorando múltiples dinámicas D/s, desde la obediencia más sutil hasta la entrega más intensa.
